// https://github.com/tetherto/lib-wallet/blob/main/example/web/README.md

'use strict';

// Edit these to your own local instances
const WHISPR = 'http://localhost:8080/v1/audio/transcriptions';
...
const PHRASE =
  'tiger skull peasant slogan tube infant island egg tent ensure rhythm grape';
...
async function parseTranscribe(txt) {
  const stringifiedAddrBook = JSON.stringify(book, null, 2);
  const data = {
    model: 'llama3.2',
    stream: false,
    messages: [
...
My address book of recipients is: JSON ${stringifiedAddrBook} parse the sender's address from this JSON. 
